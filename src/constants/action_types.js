...
export const SET_ORIENTATION = 'orientationChange'
...
export const START_AUTO_SLIDER = 'startAutoSlider'
export const STOP_AUTO_SLIDER = 'stopAutoSlider'
export const SLIDER_NEXT_SLIDE = 'nextSlide'
